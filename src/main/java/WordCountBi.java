...
public class WordCountBi {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(WordCountBi.class);
        job.setMapperClass(WordCountBi.TokenizerMapper.class);
        job.setReducerClass(WordCountBi.IntSumReducer.class);
